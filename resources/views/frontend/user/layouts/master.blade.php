...
<head>
    ...
    <!--favicon-->
    <link rel="icon" href="http://eventsmanager.peaksource.tn/favicon.ico">
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="dashboard" class="logo">
            ...
            <span class="logo-mini"><img width="50" height="30" src="http://img4.imagetitan.com/img4/small/14/14_peakslide.png"></span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><img  width="200" src="http://hotdoc.peaksource.tn/img/WhitePeaksource.png"></span>
        </a>
                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="http://peaksource.technology/wp-content/uploads/2015/01/mustapha.png" height="160" width="160" class="user-image" alt="User Image">
                            <span class="hidden-xs"> {{ access()->user()->name }} </span><!--change-->
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="http://peaksource.technology/wp-content/uploads/2015/01/mustapha.png" class="img-circle" alt="User Image">

                                <p>
                                {{ access()->user()->name }} <!-- change-->
                                    <small>Membere Depuis  {{ access()->user()->created_at->format("m/d/Y") }}</small>
                                </p>
                            </li>
                            <!-- Menu Footer-->
                            <li class="user-footer">
                                <div class="pull-left">
                                    <a href="dashboard" class="btn btn-default btn-flat">Profil</a>
                                </div>
                                <div class="pull-right">
                                    <a href="logout" class="btn btn-default btn-flat">Quitter</a>
                                </div>
                            </li>
                        </ul>
                    </li>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="http://peaksource.technology/wp-content/uploads/2015/01/mustapha.png" height="160" width="160" class="img-circle" alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="treeview @yield('events')">
                    <a href="/Events">
                        <i class="fa fa-table"></i>
                        <span></span>
            <span class="pull-right-container">Evénements
              <span class="label label-primary pull-right">4<!-- change Events number here --></span>
            </span>
                    </a>
                </li>
            ...
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li  @yield('users.roles')><a href="/Management/Roles"><i class="fa fa-key"></i>Roles</a></li>
                        <li  @yield('users.users')><a href="/Management/Users"><i class="fa fa-users"></i>Utilisateurs</a></li>
                    </ul>
                </li>
                ...
                <li class="treeview @yield('ordres')">
                    <a href="/Ordres">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">@yield('location')</li>
            </ol>
        </section>
    ...
    <footer class="main-footer">
        <strong>Copyrights &copy; 2016 <a href="http://peaksource.technology/">PEAKSOURCE Technology</a>.</strong> All rights
        reserved.
    </footer>
...
<!-- ./wrapper -->
<!-- jQuery 2.2.0 -->
<!--<script src="https://almsaeedstudio.com/themes/AdminLTE/plugins/jQuery/jQuery-2.2.0.min.js"></script>-->
<!-- Bootstrap 3.3.6 -->
